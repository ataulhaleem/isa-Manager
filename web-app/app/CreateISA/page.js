...
export default function MetadataForm () {
  ...
  const handleReleaseDate = date => {
    const dateString = date.format('YYYY-MM-DD')
    setInvestigationData({ ...investigationData, publicReleaseDate: dateString })
  }
            ...
            <Grid sx={{ padding: 1 }}>
                ...
                <Box sx={{ padding: 1 }}>
                  {/* <form onSubmit={handleSubmit}> */}
                    ...
                    <TextField
                      ...
                      onChange={(e) => {handleChangeInvestigation(e)}}
                      fullWidth
                      sx={{ mb: 1 }} 
                    />
              ...
              <Accordion>
                ...
                A Study contains contextualising information for one or more Assay. Metadata about the study design, study factors used, and study protocols are recorded in Study objects, as well as information similarly to the Investigation including title and description of the study, and related people and scholarly publications.
                           ...
                           {/* Study */}
                <Box sx={{ padding: 1 }}>
                <Typography sx={{ mb: 2 }}  variant='h7' color={'green'}>Number of studies added. {studyCounter}</Typography>
...
<TextField
                ...
                <AccordionActions>
                  { studyCounter != 0 ? <Button onClick={handleAddStudy}>+ add study ({studyCounter})</Button> : <Button onClick={handleAddStudy} >Add Study</Button>  }
...
<Typography sx={{ mb: 4 }}  variant='h7' color={'green'}>Number of Assays added: {studyCounter} in the study: {selectedStudy ? selectedStudy : 'No study selected'}</Typography>
...
<TextField
                      ...
                      onChange={(e) => {handleChangeAssay(e)}}
                      fullWidth
                      sx={{ mb: 1 }} 
                    />
...
<TextField
                ...
                <AccordionActions>
                { assayCounter != 0 ? <Button onClick={handleAddAssay}>+ add Assay ({studyCounter})</Button> : <Button onClick={handleAddAssay} >Add Assay</Button>  }
                </AccordionActions>
              </Accordion>
